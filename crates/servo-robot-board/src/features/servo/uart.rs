...
use crate::platform::uart2::UartRingBuffer;
...
pub static UART1_TX_BUF: UartRingBuffer<UART1_TX_BUF_SIZE> = UartRingBuffer::new();

/// UART1 RX ring buffer
pub static UART1_RX_BUF: UartRingBuffer<UART1_RX_BUF_SIZE> = UartRingBuffer::new();
